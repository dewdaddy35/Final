          ...
          <div className="home-bbq">
            ...
            <div>
              {/* <p className="home-text">
                  This website was designed to allow cooking enthusiasts to
                  search, upload, and save recipes. You can post pictures of
                  recipes you've created and comment on those recipes. Share
                  your own recipes, cooking styles, and show the world how you
                  excel in the kitchen, on the grill, with a smoker, or even on
                  the open flame.
                </p> */}
            </div>
          </div>
